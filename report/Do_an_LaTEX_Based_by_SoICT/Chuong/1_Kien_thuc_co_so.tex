...
Trong mật mã, ta đặc biệt quan tâm đến các số nguyên tố \emph{lớn} --- thường có độ dài từ $2048$ bit trở lên ( nếu là $2048$ bit thì $2^{2047} \leq  n < 2^{2048}$) --- vì chúng tạo nên nền tảng cho các bài toán khó như phân tích thừa số nguyên (RSA) và logarit rời rạc (ElGamal, DSA, ECDSA).
