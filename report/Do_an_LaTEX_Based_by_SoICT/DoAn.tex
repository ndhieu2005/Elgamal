...
\setlength{\headheight}{18pt} % Đặt chiều cao cho vùng header để tránh lỗi cảnh báo của fancyhdr.
...
\usepackage{booktabs} % Đường kẻ ngang chuyên nghiệp trong bảng (\toprule, \midrule, \bottomrule).
...
\usepackage{eso-pic} % Đặt nội dung lên nền trang (dùng cho trang bìa)
...
\begin{document}
	...
	\label{chapter:KienThucCoSo}
	\subfile{Chuong/1_Kien_thuc_co_so}

	\newpage
	\chapter{ỨNG DỤNG LƯỢC ĐỒ CHỮ KÝ SỐ ELGAMAL TRONG XÁC THỰC VĂN BẢN ĐIỆN TỬ}
	\label{chapter:UngDungElGamal}
	\subfile{Chuong/2_Ung_dung_ElGamal}

	\newpage
	\chapter{KẾT LUẬN VÀ HƯỚNG PHÁT TRIỂN}
	\label{chapter:KetLuan}
